...
const UI_COPY = {
  en: {
    ...
    persona: {
      ...
      subtitle: 'Choose a K-content persona to instantly build a curated one-day route.',
      kContentEyebrow: 'K-content one-day route',
      kContentTitle: 'Pick a K-content persona',
      kContentSubtitle: 'Choose your favorite artist and get a curated day route right away.',
      kContentStopsSuffix: ' stops',
      kContentDivider: 'K-content persona routes',
  ...
  ko: {
    ...
    persona: {
      ...
      subtitle: 'K-콘텐츠 페르소나를 선택하면 바로 하루 추천 루트가 만들어져요.',
      kContentEyebrow: 'K-콘텐츠 하루 루트',
      kContentTitle: 'K-콘텐츠 페르소나 선택',
      kContentSubtitle: '좋아하는 아티스트를 고르면 바로 하루 루트가 만들어져요.',
      kContentStopsSuffix: '곳',
      kContentDivider: 'K-콘텐츠 페르소나 루트',
      startTime: '시작 시간',
  ...
  ja: {
    ...
    persona: {
      ...
      subtitle: 'Kコンテンツのペルソナを選ぶと、すぐに1日おすすめルートが作成されます。',
      kContentEyebrow: 'Kコンテンツ1日ルート',
      kContentTitle: 'Kコンテンツのペルソナを選択',
      kContentSubtitle: '好きなアーティストを選ぶと、すぐに1日ルートが作成されます。',
      kContentStopsSuffix: 'カ所',
      kContentDivider: 'Kコンテンツペルソナルート',
      startTime: '開始時間',
  ...
  zh: {
    ...
    persona: {
      ...
      subtitle: '选择K-content角色，即可生成一日推荐路线。',
      kContentEyebrow: 'K-content一日路线',
      kContentTitle: '选择K-content角色',
      kContentSubtitle: '选择喜欢的艺人，立即生成一日路线。',
      kContentStopsSuffix: '个地点',
      kContentDivider: 'K-content角色路线',
      startTime: '开始时间',
      backToThemes: '返回路线主题',
      backToMoods: '返回路线氛围',
      chooseMood: '选择路线氛围',
